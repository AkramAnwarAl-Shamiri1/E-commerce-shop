...
<ul class="main-menu d-flex justify-content-center align-items-center">
    <li class="mx-3"><a href="{{ route('home') }}">Home</a></li>
    <li class="mx-3"><a href="{{ route('products') }}">Products</a></li>
    <li class="mx-3"><a href="{{ route('product-details') }}">Product Details</a></li>
    <li class="mx-3"><a href="{{ route('cart') }}">Cart</a></li>
    <li class="mx-3"><a href="{{ route('about-us') }}">About Us</a></li>
    <li class="mx-3"><a href="{{ route('contact') }}">Contact</a></li>
</ul>
